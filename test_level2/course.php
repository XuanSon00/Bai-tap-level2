            ...
            if($result ->num_rows >0) {
                ...
                while($row=$result->fetch_assoc()){
                    ...
                    echo "<td style='text-align:center;'>
                        ...
                        echo "<td>";
                            echo "<form method='post' action='config/course_detail.php' name='user_course_submit_form'>";
                                ...
                                echo "<button type='submit' name='user_course_submit_form' id='user_course_submit_btn' class='btn btn-primary'>Đăng ký</button>";
                                echo "</form>";
                        echo "</td>";
...
$(document).ready(function() {
  $('form[name="user_course_submit_form"]').submit(function(e) {
